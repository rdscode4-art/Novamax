...
const features = [
  ...
  },
  {
    ...
    sub: 'Quick & Easy',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="#1a3b70" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <rect x="3" y="4" width="18" height="18" rx="2" ry="2" />
        <line x1="16" y1="2" x2="16" y2="6" />
        <line x1="8" y1="2" x2="8" y2="6" />
        <line x1="3" y1="10" x2="21" y2="10" />
        <circle cx="9" cy="14" r="1" fill="#1a3b70" stroke="none" />
        <circle cx="15" cy="14" r="1" fill="#1a3b70" stroke="none" />
        <circle cx="9" cy="18" r="1" fill="#1a3b70" stroke="none" />
        <circle cx="15" cy="18" r="1" fill="#1a3b70" stroke="none" />
      </svg>
    )
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="#2f7a35" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <circle cx="12" cy="10" r="3" fill="#1a3b70" stroke="none" />
      </svg>
    )
  },
  {
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="#1a3b70" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M18 12a2 2 0 0 0-2 2v4h4v-6h-2z" fill="#1a3b70" />
      </svg>
    )
  }
];
